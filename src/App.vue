<template>
  <div style="max-width: 100vw" class="text-common">
    <div v-if="bigScreen">
      ...
      >
        <v-tab :to="'/'" :label="'首页'" color:yellow>首页</v-tab>
        <v-tab :to="'/purchase'" :label="'订单'">订单</v-tab>
        <v-tab :to="'/my'" :label="'我的'">我的</v-tab>
      </v-tabs>
...
.header-title {
  ...
  z-index: 10;
  width: 100%;
  background-image: linear-gradient(#e4ecfa, transparent);
}
.tabbar {
  position: fixed;
  bottom: 0;
