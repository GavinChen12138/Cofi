  ...
  >
    ...
    <div class="machine">
      ...
      >
        ...
        <g id="body-machine">
          <path
            fill="#FFFFFF"
            d="M30.896,238.75c-3.313,0-6-2.687-6-6v-154c0-33.222,27.028-60.25,60.25-60.25s60.25,27.028,60.25,60.25v154
                        c0,3.313-2.687,6-6,6H30.896z"
          />
          <path
            d="M85.146,24.5c29.961,0,54.25,24.289,54.25,54.25v154h-108.5v-154C30.896,48.788,55.185,24.5,85.146,24.5 M85.146,12.5
        ...
        <g id="top-machine">
          <g>
            <path
              fill="#F52929"
              d="M28.896,106.896V80.271c0-31.02,25.146-56.167,56.166-56.167l0,0c31.021,0,56.168,25.146,56.168,56.167
                            v26.624H28.896z"
            />
          </g>
          ...
          <rect
            x="46.563"
            y="33.999"
            transform="matrix(0.8093 -0.5874 0.5874 0.8093 -17.8288 42.0796)"
            fill="#FFFFFF"
            width="18.667"
            height="29"
          />
          ...
          <g>
            <g>
              <path
                d="M85.062,25.333c30.1,0,54.5,24.4,54.5,54.5v25.834h-109V79.833C30.562,49.733,54.963,25.333,85.062,25.333
        ...
        <g id="deco-blue">
          ...
          <g>
            <path
              d="M139.422,225.524v9.809H30.896v-9.809H139.422 M147.422,217.524h-8H30.896h-8v8v9.809v8h8h108.526h8v-8v-9.809V217.524
                            L147.422,217.524z"
            />
          </g>
        </g>
        ...
        <g id="head-machine">
          <g>
            <path
              fill="#FFFFFF"
              d="M129.308,83.719c0,7.271-2.324,16.378-7.902,23.886c-12.729,17.135-35.302,30.91-35.302,30.91
          ...
          <path
            fill="#66CCFF"
            d="M91.062,39.166c0,0,7.769,4.807,14.5,13.25c6.137,7.698,11.309,18.519,11,29.5c-0.75,26.75-16,41-22.75,49
          ...
          <g id="boca-pronto">
            <path
              d="M85.646,109.833c-6.167,0-10.417-5.25-10.417-10.833c0-1.657,1.343-3,3-3h14c1.657,0,3,1.343,3,3
                            C95.229,104.167,92.062,109.833,85.646,109.833z"
            />
            <path
              fill="#FE4242"
              d="M85.463,107.5c-3.449,0-5.828-1.676-5.828-3.459c0-0.529,0.751-0.958,1.68-0.958h7.83
          ...
          <g id="boca-sopro">
            <path
              display="inline"
              d="M89.086,104.413c-1.794,0-3.2-0.697-3.954-1.857c-0.784,1.103-2.181,1.776-3.91,1.776
    ...
    <div id="hot-coffee-wrap">
      <svg
        ...
        width="20px"
        height="100px"
        enable-background="new 0 0 24 98"
      >
        <path
          id="hot-coffee-down"
          fill="#AB4D37"
          d="M16-432.954v-0.38c0-0.885,0-1.672-1-2.221v-11.779c0-0.504,0-0.958,0-1.31v-9.19c0-0.442,0-0.836-1-1.111
    ...
    <div class="mug mug1 mug-empty">
      <svg
        ...
        preserveAspectRatio="none"
        viewBox="0 0 72 77"
        enable-background="new 0 0 72 77"
      >
        <g opacity="0.6">
          <polygon
            fill="#9999D1"
            points="52.5,5 48.834,70 57.5,70 67,8.5 62.667,3.834 53.667,3.667   "
          />
        </g>
        <path
          fill="#FFFFFF"
          d="M23.452,47.76c0.176,1.276-0.717,2.454-1.994,2.63l0,0c-1.276,0.176-2.454-0.717-2.629-1.994l-4.225-30.711
                    c-0.176-1.275,0.717-2.453,1.994-2.629l0,0c1.276-0.176,2.454,0.717,2.629,1.993L23.452,47.76z"
        />
        <path
          fill="#FFFFFF"
          d="M25.349,59.106c0.201,1.459-0.819,2.806-2.278,3.006l0,0c-1.458,0.201-2.804-0.819-3.005-2.278l-0.272-1.981
                    c-0.201-1.459,0.819-2.804,2.278-3.005l0,0c1.459-0.2,2.805,0.819,3.005,2.278L25.349,59.106z"
        />
        <path
          d="M61,8c1.656,0,3,1.343,3,3l-7,54.667c0,1.657-1.344,3-3,3H19c-1.657,0-3-1.343-3-3L8,11c0-1.657,1.343-3,3-3H61 M61,0H11
      ...
      >
        <g>
          <defs>
            <path
              id="SVGID_1_"
              d="M57,65.666c0,1.656-1.344,3.001-3,3.001H19c-1.657,0-3-1.345-3-3.001L8,11.001C8,9.345,9.343,8,11,8h50
    ...
    <div class="floor">
      <svg
        preserveAspectRatio="none"
        viewBox="0 0 528 10"
        enable-background="new 0 0 528 10"
      >
        <g>
          <path
            fill="#CCCCCC"
            d="M46.074,5.171c0,2.117-1.716,3.834-3.833,3.834H3.907c-2.117,0-3.833-1.717-3.833-3.834l0,0
                        c0-2.117,1.716-3.833,3.833-3.833H42.24C44.357,1.338,46.074,3.054,46.074,5.171L46.074,5.171z"
          />
          <path
            fill="#CCCCCC"
            d="M506.072,5.338c0,2.209-1.791,4-4,4h-442c-2.209,0-4-1.791-4-4l0,0c0-2.209,1.791-4,4-4h442
                        C504.281,1.338,506.072,3.129,506.072,5.338L506.072,5.338z"
          />
          <path
            fill="#CCCCCC"
            d="M527.99,5.15c0,2.105-1.707,3.812-3.812,3.812h-6.707c-2.105,0-3.812-1.707-3.812-3.812l0,0
