  ...
  <div class="card" style="margin-top: 50px">
    <div class="layout-center">
      ...
      <div class="user-info-layout">
        <div class="user-info-layout-name">{{ user.name }}</div>
        <div class="user-info-layout-level">{{ user.level }}</div>
      </div>
    </div>
  </div>
  <div class="card">
    <div class="level-progress-layout">
      <div class="level-progress-text">
        升级至下一级还需{{ user.cupnumber }}杯
      </div>
      <div class="level-progress-svggroup" style="clo">
        <svg
          width="30px"
          height="30px"
          viewBox="0 0 277 416"
...
export default {
  data() {
    return {
      user: {
        avatar: "src/assets/images/Pic1.png",
        name: "Gavin Chen",
        level: "Lv.2",
        cupnumber: "3",
      },
...
.user-info-layout-name {
  font-size: 2.5rem;
  font-weight: bold;
}
.user-info-layout-level {
  font-size: 1.5rem;
}
.level-progress-text {
  font-size: 1rem;
